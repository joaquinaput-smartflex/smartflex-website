...
- [x] **Obtener imágenes originales** (logo, fotos proyectos)
- [x] Crear estructura de carpetas
- [ ] Separar CSS del HTML (archivo externo)
- [ ] Separar JS del HTML (archivo externo)

### Fase 2: Arreglar Imágenes Rotas
- [x] Logo SMARTFLEX (favicon y navbar)
- [x] Foto hero (colegio_panoramica)
- [x] Proyecto 1: Complejo Educativo
- [x] Proyecto 2: Residencia Moderna
- [x] Proyecto 3: Casa Contemporánea
- [x] Foto sección "Nosotros"
...
|---------|-----|-----------|
| `favicon.png` | Favicon | `assets/images/logo/` |
| `smartflex-logo-dark.png` | Logo navbar (fondo claro) | `assets/images/logo/` |
| `smartflex-logo-white.png` | Logo footer (fondo oscuro) | `assets/images/logo/` |
| `colegio-panoramica.jpg` | Hero section | `assets/images/hero/` |
| `smartflex-iot.jpg` | Hero IoT alternativo | `assets/images/hero/` |
| `colegio-educativo.jpg` | Proyecto 1 | `assets/images/projects/` |
| `residencia-moderna.jpg` | Proyecto 2 | `assets/images/projects/` |
| `casa-contemporanea.jpg` | Proyecto 3 | `assets/images/projects/` |
| `about.jpg` | Sección Nosotros | `assets/images/` |
